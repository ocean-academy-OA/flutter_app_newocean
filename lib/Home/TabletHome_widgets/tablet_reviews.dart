...
import 'package:flutter_app_newocean/Home/TabletHome_widgets/tablet_star_reviews.dart';
...
class TabletReviewsSection extends StatefulWidget {
  @override
  _TabletReviewsSectionState createState() => _TabletReviewsSectionState();
}

class _TabletReviewsSectionState extends State<TabletReviewsSection> {
  void plus() {
    List<Color> choice = [
      Colors.green[300],
      Colors.purple[300],
