...
class TabletEditProfile extends StatefulWidget {
  static bool readOnly = false;

  @override
  _TabletEditProfileState createState() => _TabletEditProfileState();
}

class _TabletEditProfileState extends State<TabletEditProfile> {
