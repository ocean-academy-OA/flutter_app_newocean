...
class DesktopEditProfile extends StatefulWidget {
  static bool readOnly = false;

  @override
  _DesktopEditProfileState createState() => _DesktopEditProfileState();
}

class _DesktopEditProfileState extends State<DesktopEditProfile> {
...
// profile picture
  ...
  void initState() {
    ...
    editProfile();
    DesktopEditProfile.readOnly = true;
  }
                  ...
                  Container(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ...
                        Visibility(
                          child: DesktopEditProfile.readOnly != false
                              ? GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      listCount = 3;
                                      DesktopEditProfile.readOnly = false;
                                      print(DesktopEditProfile.readOnly);
                                    });
                                  },
                                  child: Container(
                                    margin:
                        ...
                        Visibility(
                          visible: DesktopEditProfile.readOnly != false,
                          child: Container(
